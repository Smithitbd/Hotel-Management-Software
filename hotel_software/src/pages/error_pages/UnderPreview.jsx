...
const UnderPreview = () => {
  const { logOut } = useAuth(); // or signOut — match your useAuth export
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-teal-50/40 p-6">
      <motion.div
        ...
        >
          ...
          <div className="flex min-h-[420px] flex-col items-center justify-center px-8 py-14 text-center">
            ...
            <p className="mt-8 max-w-sm text-xs leading-5 text-gray-400">
              This usually takes 24–48 hours. You’ll receive a confirmation once
